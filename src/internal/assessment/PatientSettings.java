 ...
 */
public class PatientSettings extends javax.swing.JPanel {
    String nm[]; //public variable - available in all the things
int count=0;

    /**
     * Creates new form PatientSettings
     */
 ...
 FileReader fr = new FileReader("patientLoggedIn.txt");//tells which file
    ...
    private void initComponents() {
        ...
        reenteremail1 = new javax.swing.JTextField();
...
try
{
    ...
    for (int i = 0; i<count; i++)
    {
        ...
        if (idEdit.equals(id1))
        {
            ...
            {
               pr.println(ide.getText() + "," + firstname.getText()+ ","  + lastname.getText()+ ","  + password.getText() + "," + age.getText() + "," + email.getText() + "," + gender22+ "," + h);  
            }
            
            else
            {
            age.setText(agec.getSelectedItem() +"");
            pr.println(ide.getText() + "," + firstname.getText()+ ","  + lastname.getText()+ ","  + password.getText() + "," + agec.getSelectedItem() + "," + email.getText() + "," + gender22+ "," + h);
        }
            }
    ...
    private javax.swing.JTextField reenteremail1;
